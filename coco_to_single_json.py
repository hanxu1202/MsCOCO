...
class CocoDatasetHandler:
    ...
    def save_labelme(self, file_names, dirpath, save_json_only=False):
        ...
        for index, file in enumerate(file_names):
            print(str(index)+'/' + str(len(file_names)) + '  current file: ' + file)
...
ds = CocoDatasetHandler('E:\COCO2017/annotations/instances_train2017.json', 'E:\COCO2017/train2017')
ds.coco2labelme()
ds.save_labelme(ds.labelme.keys(), 'E:\COCO2017/train2017_single_json')